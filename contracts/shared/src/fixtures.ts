...
export const USER_SESSION_FIXTURE: UserSession = {
...
export const PERMISSION_SNAPSHOT_FIXTURE: PermissionSnapshot = {
  userId: 'user-123',
  roles: ['admin'],
...
export const BFF_ERROR_FIXTURE: BffErrorEnvelope = {
  code: 'FORBIDDEN',
