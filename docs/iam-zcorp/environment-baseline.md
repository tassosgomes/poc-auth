...
- BFF_JAVA_UPSTREAM_URL=http://java-authpoc:8080
- BFF_DOTNET_UPSTREAM_URL=http://dotnet-authpoc:8080
...
- BFF_OIDC_TRANSACTION_TTL_SECONDS=600
- BFF_REFRESH_LOCK_TTL_MS=5000
- BFF_ACCESS_TOKEN_REFRESH_SKEW_SECONDS=30
- BFF_PERMISSION_SNAPSHOT_CACHE_TTL_SECONDS=300
- BFF_ROLE_ACCESS_CACHE_TTL_SECONDS=3600
